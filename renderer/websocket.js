...
const messageTypes = ['ORDERS', 'TICKERS', 'TRADES', 'BALANCES', 'SETTINGS', 'STATUS', 'WEBSOCKET_SUCCESS', 'WEBSOCKET_ERROR', 'WEBSOCKET_PENDING', 'UPDATE_EMAIL', 'REMOVE_ORDER', 'ADD_ORDERS', 'OPEN_SNACKBAR_REDIRECT', 'RESET_DATA'];
